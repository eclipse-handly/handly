    ...
    implements IPropertyChangeListener
{
    ...
    public static boolean isMemberOrderProperty(String property)
    {
        return PreferenceConstants.APPEARANCE_MEMBER_SORT_ORDER.equals(property)
            || PreferenceConstants.APPEARANCE_VISIBILITY_SORT_ORDER.equals(
                property)
            || PreferenceConstants.APPEARANCE_ENABLE_VISIBILITY_SORT_ORDER.equals(
                property);
    }
    ...
    private int[] getVisibilityOffsets()
    {
        ...
        {
            store.setToDefault(key);
            fillVisibilityOffsetsFromPreferenceString(
